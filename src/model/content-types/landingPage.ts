...
import type { Video, Disclaimer, CallToAction, FactSectional, Event, Article, Page } from "./index.ts";
...
export type LandingPage = CoreContentType<
  LandingPageElementCodenames,
  {
     ...
     */
    readonly body_copy: Elements.RichTextElement<Video | Disclaimer | CallToAction | FactSectional>;
    /**
     * Featured Content
     *
